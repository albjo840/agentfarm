...
const TRANSLATIONS = {
    sv: {
        ...
        "vision.limitations_queue": "Köer kan uppstå - En GPU, många användare. Ibland får du vänta på din tur.",
        "vision.limitations_precision": "Mindre precision - Agenterna kan vara lite mer \"distraherade\" än jättarna i molnet. De behöver tydligare instruktioner.",
        "vision.limitations_context": "Begränsat arbetsminne - För att hålla systemet snabbt begränsar vi kontextfönstret (hur mycket agenten minns av samtalet samtidigt). Bifoga inga enorma dokument.",
        "vision.limitations_failures": "Processer kan faila - Ibland går det inte som planerat. Det är en del av resan i ett experimentellt skede.",
        "vision.limitations_prompts": "Prompt-känslighet - Dina instruktioner får inte alltid lika exakt genomslag som hos modeller med hundratals miljarder parametrar.",
        ...
        "vision.strengths_privacy": "Privacy-first - Känslig företagsdata, intern kod och dokument du aldrig skulle skicka till en molntjänst är säkra och anonyma.",
        ...
        "vision.upgrade_difference": "Skillnaden är enorm: Att gå från 7B till 30B+ parametrar är där agenten slutar \"gissa\" och börjar \"förstå\" komplexa instruktioner. Med mer VRAM kan agenterna läsa hela dokument och behålla tråden i långa resonemang.",
    ...
    en: {
        ...
        "vision.limitations_queue": "Queues may occur - One GPU, many users. Sometimes you have to wait your turn.",
        "vision.limitations_precision": "Less precision - The agents can be a bit more \"distracted\" than the giants in the cloud. They need clearer instructions.",
        "vision.limitations_context": "Limited working memory - To keep the system fast we limit the context window (how much the agent remembers at once). Don't attach huge documents.",
        "vision.limitations_failures": "Processes can fail - Sometimes it doesn't go as planned. It's part of the journey in an experimental phase.",
        "vision.limitations_prompts": "Prompt sensitivity - Your instructions don't always have the same exact impact as with models with hundreds of billions of parameters.",
        ...
        "vision.strengths_privacy": "Privacy-first - Sensitive company data, internal code and documents you would never send to a cloud service are safe and anonymous.",
        ...
        "vision.upgrade_difference": "The difference is huge: Going from 7B to 30B+ parameters is where the agent stops \"guessing\" and starts \"understanding\" complex instructions. With more VRAM, agents can read entire documents and keep track of long reasoning chains.",
